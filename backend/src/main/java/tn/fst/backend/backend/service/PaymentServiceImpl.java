...
public class PaymentServiceImpl implements PaymentService {
    ...
    public Payment updatePayment(Long id, Payment paymentDetails) {
        ...
        if (!optional.isPresent()) throw new RuntimeException("Payment not found with id: " + id);

        Payment payment = optional.get();
        payment.setModePayment(paymentDetails.getModePayment());
    ...
    public Payment refundPayment(Long paymentId) throws StripeException {
        ...
        if (payment.getPaymentMethod() == PaymentMethod.STRIPE && payment.getPaymentIntentId() != null) {
